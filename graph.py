...
if __name__ == "__main__":
    ...
    spec = Spec(
        description="Determine if a given linked list contains a cycle.",
    ...
    print(
        f"models: code={settings.default_code_model} test={settings.default_test_model}")
    ...
    print("--- code ---\n\n", result["code_branch"].content)
    print("--- tests ---\n\n", result["test_branch"].content)
    print("--- gate results ---")
    for r in result["gate_results"]:
        print(r)
    print("terminal_state:", result["terminal_state"])
